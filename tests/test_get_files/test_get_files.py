...
def test_get_files_paths_items():
    ...
    assert next(gen) == [
        "tests/src/get_files_2/2023/November/10/7/www___example___com__page_90.html",
        "www.example.com/page", 90]
...
def test_get_files_paths_sep():
    ...
    gen = get_files_paths(fp, ".html", "|")
    assert next(gen) == [
        "tests/src/get_files_3/2023/November/10/7/www___example___com__page_3|90.html",
        "www.example.com/page_3",
        90
    ]
